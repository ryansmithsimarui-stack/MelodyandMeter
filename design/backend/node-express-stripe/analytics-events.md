...
## Booking Funnel Events (Resource-Aware v0.7)
...
|--------|------------|-----------------|-----------------|
| `start` | `booking_started` | `booking_id`, `user_id`, `resource_id` | `channel` |
| `view_availability` | `booking_view_availability` | `user_id`, `resource_id` | `instrument`, `source` |
| `open_slot` | `booking_slot_open` | `booking_id`, `slot_id`, `user_id`, `resource_id` | (none) |
| `select_slot` | `booking_slot_selected` | `booking_id`, `slot_id`, `user_id`, `resource_id` | `instrument` |
...
## Reschedule Events (Resource-Aware v0.7)
...
- v0.7: Added `resource_id` to all booking funnel instrumentation events (start, view_availability, open_slot, select_slot).
